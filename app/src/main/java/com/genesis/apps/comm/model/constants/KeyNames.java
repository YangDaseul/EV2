...
public interface KeyNames {
    ...
    String KEY_NAME_CONTENTS_VO="contentsVO";
    ...
    String KEY_NAME_LOCATION_OTHERS="othersLocation";
...
//    String KEY_NAME_REVIEW_TRANS_ID = "transId";
    ...
    String KEY_NAME_FILTER_INFO = "filterInfo";

    String KEY_NAME_CHARGE_STATION_SPID = "chargeStationSPID";
